...
export default function CircularProgressBarV3({
  progress,
  size = 120,
  strokeWidth = 4,
  color = '#FFFFFF',
  ...
  // Crear el gradiente del progreso usando un enfoque de arco continuo
  const renderProgressArc = () => {
    const segments = 180; // Muchos segmentos para un efecto muy suave
