...
async function createAffiliateCodeProduction() {
  console.log('🔧 Creando código de afiliado en producción...\n');

  try {
    // 1. Verificar que el usuario existe
    console.log('1️⃣ Verificando usuario angelafiliado2@gmail.com...');
    ...
    // 3. Crear código de afiliado manualmente
